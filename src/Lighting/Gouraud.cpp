//
// Draw boxes on the screen using Gouraud shading.
...
int main()
{
    ...
    // Load Object Shader
    Shader objectShader("shaders/Gouraud.vert", "shaders/Gouraud.frag");
    objectShader.use();
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        for (int i = 0; i < 2; ++i) {
            ...
            if (i == 0) model = glm::scale(model, glm::vec3(1.3f, 2.0f, 1.0f));
            else model = glm::scale(model, glm::vec3(0.8f, 0.4f, 1.5f));
